...
function elevarAlCuadrado(num) {
  ...
  // Tu código:
  var numeroElevadoAlCuadrado = Math.pow(num, 2);
  return numeroElevadoAlCuadrado;
}

function elevarAlCubo(num) {
  // Devuelve el valor de "num" elevado al cubo
  // Tu código:
  var numeroElevadoAlCubo = Math.pow(num, 3);
  return numeroElevadoAlCubo;
}
...
function agregarSimboloExclamacion(str) {
  ...
  // Tu código:
  var masExclamacion = str + "!";
  return masExclamacion;
}
...
function retornarPerimetro(lado){
  ...
  var perimetroDeCuadrado = lado * 4;
